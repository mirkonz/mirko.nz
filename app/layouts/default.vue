<template>
  <Html :lang="head.htmlAttrs.lang" :dir="head.htmlAttrs.dir">
    <ColorScheme>
      ...
      >
        <Button
          v-if="!showCaptcha && !showDialog"
          class="hover:scale-110 fixed z-50 bottom-1/5 sm:bottom-48 left-1/2 transform -translate-x-1/2"
      ...
      >
        <div
          v-if="showCaptcha && !showDialog"
          class="fixed z-50 p-32 inset-0 flex flex-col items-center justify-center gap-2 bg-white-darker dark:bg-black"
        >
          <h3 class="text-2xl text-primary">Connect the dots</h3>
          ...
          <button
            type="button"
            class="mt-1 rounded px-3 py-1 text-sm text-black dark:text-white"
